...
export const metadata: Metadata = {
  title: "Tampa Home Renovation Contractor | Quality Restoration & Renovations",
  description:
    "Licensed Tampa home renovation contractor. Free in-home consultation. Financing available. Kitchen, bathroom, and full home renovations. 25+ years serving Tampa Bay.",
...
const faqItems = [
  {
    ...
    answer:
      "Costs vary based on scope, materials, and project size. The team provides detailed written estimates after a free in-home consultation, so there are no surprises. Financing is available.",
  },
  {
    question: "How long does a renovation take?",
    answer:
      "Most kitchen and bathroom renovations run 4 to 8 weeks. Full home renovations run longer. The team provides a clear schedule before work begins and updates throughout.",
  },
  {
    question: "Are you really licensed and insured?",
    answer:
      "Yes. The firm holds Florida General Contractor License CGC1523357, the highest state classification for building contractors. Fully bonded and insured for residential and commercial work.",
  },
  {
    question: "Do you handle insurance claims for fire or flood damage?",
    answer:
      "Yes. The team uses Xactimate to coordinate with insurance providers and streamline the claim process from initial estimate through completion.",
  },
];

export default function HomeRenovationsLandingPage() {
  return (
    <>
      {/* Sticky Utility Bar */}
      ...
      <section className="relative min-h-[65vh] md:min-h-[600px] lg:min-h-[calc(100vh-64px)] overflow-hidden">
        <div className="absolute inset-0">
          ...
          <Image src="/images/correct/bathroom-white-vanity-gold-mirror-glass-shower-tampa.jpg" alt="White vanity bathroom with glass shower enclosure in Tampa" fill className="object-cover hidden md:block" priority />
        </div>
        ...
        <div className="relative flex items-end md:items-center min-h-[65vh] md:min-h-[600px] lg:min-h-[calc(100vh-64px)]">
          <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-12 md:py-16 w-full">
            <div className="lg:grid lg:grid-cols-12 lg:gap-12 lg:items-center">
              ...
              <HeroContainer className="lg:col-span-7">
                <HeroItem>
                  <p className="font-sans font-medium text-xs tracking-[0.15em] uppercase text-white/80 mb-6">
                    Tampa, FL &nbsp;&bull;&nbsp; Licensed Contractor &nbsp;&bull;&nbsp; CGC1523357
                  </p>
                </HeroItem>
                <HeroItem>
                  <h1 className="font-sans font-extrabold text-4xl md:text-6xl lg:text-7xl leading-[0.95] tracking-[-0.035em] text-white mb-6">
                    Tampa Home Renovations, Done Right the First Time.
                  </h1>
                </HeroItem>
                <HeroItem>
                  <p className="font-sans text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mb-8">
                    Kitchen, bathroom, and full home renovations across Tampa Bay.
                    Free in-home consultation. Financing available. Licensed,
                    bonded, and insured for 25+ years.
                  </p>
                </HeroItem>
                <HeroItem>
              ...
              {/* Right Column: Form (desktop only, overlaps hero) */}
              <div className="hidden lg:block lg:col-span-5" id="lead-form">
                <div className="bg-white p-10 rounded-[2px]">
                  ...
                  <LandingForm source="landing-page-home-renovations-tampa" />
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Mobile Form — sits below hero on bone background */}
      ...
      <section className="bg-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-16 md:py-20 lg:py-28">
          ...
          <h2 className="font-sans font-extrabold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-navy max-w-3xl mb-12">
            Every part of the home. One licensed team.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <div className="relative aspect-[4/3] w-full"><Image src="/images/kitchen-gray-cabinets-island-bar-stools-tampa.jpg" alt="Modern gray kitchen with center island and bar stools" fill className="object-cover" /></div>
              <div className="pt-5">
                ...
                <p className="font-sans text-sm text-ink leading-relaxed mt-2">
                  Custom cabinets, countertops, lighting, full layouts.
                </p>
              </div>
            </div>
            <div>
              <div className="relative aspect-[4/3] w-full">
                <Image src="/images/correct/bathroom-white-vanity-gold-mirror-glass-shower-tampa.jpg" alt="White vanity bathroom with glass shower enclosure" fill className="object-cover md:hidden" />
                <Image src="/images/correct/bathroom-blue-marble-freestanding-tub-glass-shower-tampa.jpg" alt="Blue marble bathroom with freestanding tub" fill className="object-cover hidden md:block" />
              </div>
              <div className="pt-5">
                <h3 className="font-sans font-bold text-lg md:text-xl text-navy tracking-[-0.02em] leading-tight">
                  Bathroom Remodeling
                ...
                <p className="font-sans text-sm text-ink leading-relaxed mt-2">
                  Spa-inspired tile, vanities, fixtures, and storage.
                </p>
              </div>
            </div>
            <div>
              <div className="relative aspect-[4/3] w-full"><Image src="/images/entryway-staircase-iron-chandelier.jpg" alt="Tampa home entryway with wood staircase and iron chandelier" fill className="object-cover" /></div>
              <div className="pt-5">
                <h3 className="font-sans font-bold text-lg md:text-xl text-navy tracking-[-0.02em] leading-tight">
                  Full Home Renovation
                </h3>
                <p className="font-sans text-sm text-ink leading-relaxed mt-2">
                  Whole-home renovations from one trusted contractor.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-bone">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-16 md:py-20 lg:py-28">
          ...
          <h2 className="font-sans font-extrabold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-navy max-w-3xl mb-16">
            Three reasons Tampa homeowners choose us.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <h3 className="font-sans font-bold text-xl md:text-2xl text-navy tracking-[-0.02em] leading-tight mb-3">
                25 Years of Tampa Work.
              </h3>
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                Quarter century of residential and commercial renovations across
                Hillsborough, Pinellas, and Pasco. The team knows local code,
                local materials, and the realities of Florida construction.
              </p>
            </div>
            <div>
              <p className="font-sans font-extrabold text-5xl md:text-6xl text-taupe tracking-[-0.04em] leading-none mb-6">
              ...
              <h3 className="font-sans font-bold text-xl md:text-2xl text-navy tracking-[-0.02em] leading-tight mb-3">
                Florida's Highest Contractor License.
              </h3>
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                Certified General Contractor (CGC1523357), the top state
                classification for building contractors. Fully bonded and
            ...
            <div>
              ...
              <h3 className="font-sans font-bold text-xl md:text-2xl text-navy tracking-[-0.02em] leading-tight mb-3">
                In-House Teams. No Surprises.
              </h3>
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                Licensed crews handle the work directly. Clean job sites, honest
                schedules, and a single point of accountability from start to
                finish.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-16 md:py-20 lg:py-28">
          ...
          <h2 className="font-sans font-extrabold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-navy max-w-3xl mb-16">
            Three steps to a finished project.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                ...
                consultation to walk the space, listen to the goals, and set the
                scope.
              </p>
            </div>
            <div>
              ...
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                ...
                realistic timeline, no high-pressure tactics.
              </p>
            </div>
            <div>
              <p className="font-sans font-medium text-xs tracking-[0.15em] uppercase text-taupe mb-3">
              ...
              <p className="font-sans text-base text-ink leading-relaxed max-w-sm">
                Licensed crews execute the work with clean job sites, consistent
                updates, and a final walkthrough before close-out.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-bone">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-16 md:py-20 lg:py-28">
          ...
          <h2 className="font-sans font-extrabold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-navy max-w-3xl mb-16">
            Renovations across Tampa Bay.
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="relative aspect-[4/3]"><Image src="/images/bathroom-blue-marble-double-vanity-led-mirror.jpg" alt="Blue marble bathroom with double vanity and LED mirror" fill className="object-cover" /></div>
            <div className="relative aspect-[4/3]"><Image src="/images/kitchen-island-with-banquette-seating.jpg" alt="Kitchen with island and banquette seating" fill className="object-cover" /></div>
            <div className="relative aspect-[4/3]"><Image src="/images/master-bedroom-mirrored-furniture-tray-ceiling.jpg" alt="Master bedroom with mirrored furniture and tray ceiling" fill className="object-cover" /></div>
            <div className="relative aspect-[4/3]"><Image src="/images/patio-remodel-after.jpg" alt="Completed Tampa patio renovation" fill className="object-cover" /></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-sans font-extrabold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-white mb-6">
                Financing makes the project possible.
              </h2>
              <p className="font-sans text-base md:text-lg text-white/85 leading-relaxed max-w-md">
                Renovation financing is available through trusted partner
                lenders. Whether the project is a kitchen refresh or a full home
                renovation, the team can help structure financing that works
                alongside the construction timeline.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="font-sans text-xs text-white/60 mt-3">
                Florida License CGC1523357 &nbsp;&bull;&nbsp; Licensed, Bonded, Insured
              </p>
            </div>
            <div>
              <a
